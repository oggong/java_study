...
//        final BarRenderer renderer = new BarRenderer();
        ...
        renderer.setSeriesPaint(0, new Color(71,200,61));
        ...
        final JFreeChart chartc = new JFreeChart(plot);
        chartc.setTitle(" 카페 일별 판매량 현황 "); 
        TextTitle copyright = new TextTitle("일별 판매량 ", new Font("SansSerif", Font.PLAIN, 9));
        copyright.setHorizontalAlignment(HorizontalAlignment.RIGHT);
        chartc.addSubtitle(copyright);  
        return chartc;
    }
}
